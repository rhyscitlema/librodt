...
extern bool save_file_as (const mchar* fileName); // save entry text field in a file


extern bool open_file (const mchar* fileName); // open a file and load into entry text field
...
extern const mchar* file_name_get ();
